...
const VALID_YOUTUBE_IDS = [
  ...
  'kTJczUoc26U', // Stay
  'tQ0yjYUVDnI', // Peaches
  'E07s5ZYygMg', // Watermelon Sugar
  'ZmDBbnmKpqQ', // Drivers License
  'gNi_6U5Pm_o', // Good 4 U
  'OPf0YbXqDm0', // Uptown Funk
  'q0hyYWKXF0Q', // Dance Monkey
  'zABLecsR5UE', // Someone You Loved
  'ApXoWvfEYVU', // Sunflower
  'Pkh8UtuejGw', // Senorita
  'DyDfgMOUjCI', // Bad Guy
  'bo_efYhYU2A', // Shallow
];
...
const SONG_DATABASE: Song[] = [
  ...
  ...song,
  id: VALID_YOUTUBE_IDS[index % VALID_YOUTUBE_IDS.length]
}));
